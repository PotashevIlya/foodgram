...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', default='hosts').split(', ')
...
DJOSER = {
    ...
    'HIDE_USERS': False,
    'SERIALIZERS': {
        'user': 'api.serializers.FoodgramUserReadSerializer',
        'current_user': 'api.serializers.FoodgramUserReadSerializer',
    },
    'PERMISSIONS': {
